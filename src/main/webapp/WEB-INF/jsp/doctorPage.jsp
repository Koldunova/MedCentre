    ...
    <div class="main-content">
        ...
        <div class="title-area">
            <div class="title-inner container paddings-side">
                <div class="title-x-large title-color-white"> Врачи</div>
            </div>
        </div>
      
        <section class="team-section">
            <div class="team-section-inner container paddings">
                <div class="title-h2"><span class="title-color-blue">Наши</span> специалисты</div>
                <div class="divider-20"></div>
            </div>
        </section>
        <section class="team-grid doctors">
