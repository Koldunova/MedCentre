...
CREATE TABLE `doctor_education` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKa9jto7iwc0y5j3jbcw18bp98l` (`inst_id`),
  KEY `FKm1x6kr4p814jhlu48pvimwqjw` (`speciality_id`),
  KEY `FKjx7kwct5b7ase8p7etkkgul14` (`doctor_id`),
  CONSTRAINT `FKa9jto7iwc0y5j3jbcw18bp98l` FOREIGN KEY (`inst_id`) REFERENCES `education_inst` (`id`),
  CONSTRAINT `FKjx7kwct5b7ase8p7etkkgul14` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`id`),
  CONSTRAINT `FKm1x6kr4p814jhlu48pvimwqjw` FOREIGN KEY (`speciality_id`) REFERENCES `speciality` (`id`)
